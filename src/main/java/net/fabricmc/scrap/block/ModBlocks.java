...
public class ModBlocks{
    public static final Block SCRAP_BLOCK = registerBlock("scrap_block",new Block(FabricBlockSettings.of(Material.METAL).strength(6.0f).requiresTool()),ItemGroup.BUILDING_BLOCKS);

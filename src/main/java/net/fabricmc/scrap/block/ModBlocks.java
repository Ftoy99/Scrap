...
import net.fabricmc.scrap.block.ducts.itemducts.ItemDuct;
...
public class ModBlocks{
    ...
    public static final Block ITEM_DUCT = registerBlock("item_duct",new ItemDuct(0.2500f,FabricBlockSettings.of(Material.GLASS).strength(2.0F, 2.0F).nonOpaque()), ModItemGroup.SCRAP);

...
public class CrusherEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public CrusherEntity(BlockPos pos, BlockState state) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    case 0:
                        return (int) CrusherEntity.this.energyStorage.amount;
                    case 1:
                        return CrusherEntity.this.progress;
                    case 2:
                        return (int) CrusherEntity.this.energyStorage.capacity;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0:
                        CrusherEntity.this.energyStorage.amount = value;
                        break;
                    case 1:
                        CrusherEntity.this.progress = value;
                        break;
                    default:
                        break;
                }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, CrusherEntity entity) {
            if (hasRecipe(entity)) {

...
public class BlockBreakerScreen extends HandledScreen<BlockBreakerScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(Main.MOD_ID,"textures/gui/block_breaker_gui.png");
    public BlockBreakerScreen(BlockBreakerScreenHandler handler, PlayerInventory inventory, Text title) {
